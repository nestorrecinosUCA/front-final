        ...
        <>
            <section class="max-w-4xl p-6 mx-auto bg-gray-500 rounded-md shadow-md dark:bg-gray-600 mt-4">
                ...
                <form>
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input id="range" type="range" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-800 rounded-md dark:bg-gray-700 dark:text-gray-800 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                        </div>
                        <div>
                ...
                <div class="flex justify-end mt-6">
                    <button class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-pink-500 rounded-md hover:bg-pink-700"
                        onClick={MostrarAlerta}>Guardar</button>
                </div>
            </section>
            ...
            <section class="max-w-4xl p-6 mx-auto bg-gray-500 rounded-md shadow-md dark:bg-gray-600 mt-4 mb-4">
                ...
                <form>
                    ...
                    <div class="flex justify-end mt-4">
                        <button class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-pink-500 rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600">Agregar</button>
                    </div>

                    <div>
                        <div className='mx-4 border-b-2 lg:mx-20 lg:border-b-4 md:border-b-4 2xl:border-b-4 rounded mt-10' />
                        <div class="flex flex-col mt-4 bg-gray-800 dark:bg-gray-800 ">
